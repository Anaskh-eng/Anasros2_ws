...
def main():
    ...
    mission = [
        ...
        {'name': 'L/U Station (Load M1)', 'x': -3.5, 'y': 0.0, **north, 'pause_time': PAUSE, 'is_station': True},
        
        
        {'name': 'Machine 1 (Unload)', 'x': -1.0, 'y': 2.5, **north, 'pause_time': PAUSE, 'is_station': True},
        

        # --- CYCLE 2: MACHINE 2 (BLUE) ---
        
        
        {'name': 'L/U Station (Load M2)', 'x': -3.5, 'y': 0.2, **north, 'pause_time': PAUSE, 'is_station': True},
        
        {'name': 'Machine 2 (Unload)', 'x': 1.5, 'y': 2.5, **north, 'pause_time': PAUSE, 'is_station': True},
        ...
        {'name': 'Machine 3 (Unload)', 'x': 0.0, 'y': -1.5, **north, 'pause_time': PAUSE, 'is_station': True},

        # --- CYCLE 4: MACHINE 4 (MAGENTA) ---
        
        {'name': 'L/U Station (Load M4)', 'x': -3.8, 'y': 0.0, **north, 'pause_time': PAUSE, 'is_station': True},
        
        {'name': 'Machine 4 (Unload)', 'x': 2.5, 'y': -1.5, **north, 'pause_time': PAUSE, 'is_station': True},
