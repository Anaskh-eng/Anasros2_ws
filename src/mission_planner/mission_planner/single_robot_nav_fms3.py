...
def main():
    ...
    mission = [
        ...
        {'name': 'L/U Station (Load M1)', 'x': 0.0, 'y': -3.3, **north, 'pause_time': PAUSE, 'is_station': True},
        
        
        {'name': 'Machine 1 (Unload)', 'x': -1.0, 'y': -1.2, **north, 'pause_time': PAUSE, 'is_station': True},
        

        # --- CYCLE 2: MACHINE 2 (BLUE) ---
        
        
        {'name': 'L/U Station (Load M2)', 'x': 0.0, 'y': -3.5, **north, 'pause_time': PAUSE, 'is_station': True},
        
        {'name': 'Machine 2 (Unload)', 'x': -3.2, 'y': 0.5, **north, 'pause_time': PAUSE, 'is_station': True},
        

        # --- CYCLE 3: MACHINE 3 (YELLOW) ---
        
        {'name': 'L/U Station (Load M3)', 'x': 0.0, 'y': -3.5, **north, 'pause_time': PAUSE, 'is_station': True},
        
        {'name': 'Machine 3 (Unload)', 'x': 3.2, 'y': 0.5, **north, 'pause_time': PAUSE, 'is_station': True},

        # --- CYCLE 4: MACHINE 4 (MAGENTA) ---
        
        {'name': 'L/U Station (Load M4)', 'x': 0.0, 'y': -3.5, **north, 'pause_time': PAUSE, 'is_station': True},
        
        {'name': 'Machine 4 (Unload)', 'x': 1.0, 'y': -1.2, **north, 'pause_time': PAUSE, 'is_station': True},

        # Return to Home Base
        
        {'name': 'Home Base', 'x': 0.0, 'y': -3.5, **north, 'pause_time': 0.0, 'is_station': True}
    ]
