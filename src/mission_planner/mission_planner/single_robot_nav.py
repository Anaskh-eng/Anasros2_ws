...
def main():
    ...
    mission = [
        ...
        {'name': 'L/U Station (Load M1)', 'x': 0.0, 'y': -3.5, **north, 'pause_time': PAUSE, 'is_station': True},
        
        
        {'name': 'Machine 1 (Unload)', 'x': -4.5, 'y': 2.0, **north, 'pause_time': PAUSE, 'is_station': True},
        ...
        {'name': 'Machine 2 (Unload)', 'x': -1.5, 'y': 2.0, **north, 'pause_time': PAUSE, 'is_station': True},
        ...
        {'name': 'Machine 3 (Unload)', 'x': 1.5, 'y': 2.0, **north, 'pause_time': PAUSE, 'is_station': True},

        # --- CYCLE 4: MACHINE 4 (MAGENTA) ---
        
        {'name': 'L/U Station (Load M4)', 'x': 0.0, 'y': -3.5, **north, 'pause_time': PAUSE, 'is_station': True},
        
        {'name': 'Machine 4 (Unload)', 'x': 4.5, 'y': 2.0, **north, 'pause_time': PAUSE, 'is_station': True},
